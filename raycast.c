...
/*   Updated: 2024/01/23 19:22:12 by lthong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_ray(t_cub *cub, int psize)
{
	...
	while (r < 60)
	{
		...
		while (dof < 8)
		{
			...
			if (cub->ray.mx >= 0 && cub->ray.mx < cub->data.map_width && cub->ray.my >= 0 && cub->ray.my < cub->data.map_height && cub->map[cub->ray.my][cub->ray.mx] == '1')
			{
				...
				cub->ray.dist_h = dist(cub->player.pos_x, cub->player.pos_y, cub->ray.hx, cub->ray.hy);
				dof = 8;
			}
			else
			{
		...
		while (dof < 8)
		{
			...
			if (cub->ray.mx >= 0 && cub->ray.mx < cub->data.map_width && cub->ray.my >= 0 && cub->ray.my < cub->data.map_height && cub->map[cub->ray.my][cub->ray.mx] == '1')
			{
				...
				cub->ray.dist_v = dist(cub->player.pos_x, cub->player.pos_y, cub->ray.vx, cub->ray.vy);
				dof = 8;
			}
			else
			{
